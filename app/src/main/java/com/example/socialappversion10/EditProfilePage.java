...
public class EditProfilePage extends AppCompatActivity {
    ...
    //I Need to check it's usage, It's selecting image only
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setting_image= findViewById(R.id.setting_profile_image);
        pd = new ProgressDialog(this);
        pd.setCanceledOnTouchOutside(false);
        editpassword = findViewById(R.id.changepassword);
        editbio=findViewById(R.id.changebio);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    try {
                        Glide.with(EditProfilePage.this).load(image).into(setting_image);
                    } catch (Exception e) {
                    }
                }
            }
        ...
        //Here We are clicking to change the profile Picture
    ...
    private void changeBio(final String key) {
    ...
    private void uploadProfileCoverPhoto(final Uri uri) {
        ...
        StorageReference profilePicRef = storageRef.child("profile_pictures/" + firebaseUser.getUid() + ".jpg");


        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        bitmap.compress(Bitmap.CompressFormat.JPEG, 100, baos);
        byte[] dataBytes = baos.toByteArray();
        UploadTask uploadTask = profilePicRef.putBytes(dataBytes);
